...
class CapslueScan extends StatefulWidget {
  const CapslueScan({super.key});

  @override
  CapslueScanState createState() => CapslueScanState();
}

class CapslueScanState extends State<CapslueScan> {
